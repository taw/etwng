XmlSplit = {
  ...
  :CAI_WORLD_REGION_HLICS        => "cai_region_hlics/",
  ...
  :GOVERNMENT                    => "government/%s-%d", # Uses gov_type, should use faction :-/
  ...
  :REGION                        => 'region/%s',
  :REGION_SLOT_ARRAY             => "region_slot/%s-%d",
